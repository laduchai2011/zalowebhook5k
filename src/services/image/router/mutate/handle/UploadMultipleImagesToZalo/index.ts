...
class Handle_UploadMultipleImagesToZalo {
    ...
    upload = (): multer.Multer => {
        console.log(11111111, 'Handle_UploadMultipleImagesToZalo', 'upload');
        ...
        console.log(22222222222, 'Handle_UploadMultipleImagesToZalo', 'upload');
    ...
    main = async (req: Request, res: Response) => {
        ...
        try {
            ...
            for (const file of files) {
                ...
                console.log(5555555555555, 'Handle_UploadMultipleImagesToZalo', 'main', uploadRes);
